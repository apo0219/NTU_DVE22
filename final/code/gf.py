...
def guided_filter( I, p, r = 4 , eps = 0.0001, resize = None ) :
    ...
    if resize :
        h_prime = h//resize
        w_prime = w//resize
        p = transform.resize( p, ( h_prime, w_prime ), order = 1 )
        Ir = transform.resize( Ir, ( h_prime, w_prime ), order = 1 )
        Ig = transform.resize( Ig, ( h_prime, w_prime ), order = 1 )
        Ib = transform.resize( Ib, ( h_prime, w_prime ), order = 1 )
    ...
    if resize :
        ar = transform.resize( ar, ( h, w ), order = 1 )
        ag = transform.resize( ag, ( h, w ), order = 1 )
        ab = transform.resize( ab, ( h, w ), order = 1 )
        b = transform.resize( b, ( h, w ), order = 1 )
